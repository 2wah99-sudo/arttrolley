...
const GalleryModal = ({ selectedItem, isOpen, onClose, setSelectedItem, mediaItems }: GalleryModalProps) => {
    ...
    return (
        <>
            ...
            >
                <motion.div
                    className="relative rounded-xl backdrop-blur-xl shadow-lg cursor-grab active:cursor-grabbing"
                    style={{ background: 'rgba(214,67,47,.14)', border: '1px solid rgba(214,67,47,.3)' }}
                >
                    ...
                    >
                        {items.map((item, index) => (
                            <motion.div
                                ...
                                style={{ background: '#000', border: '1px solid rgba(214,67,47,.16)' }}
